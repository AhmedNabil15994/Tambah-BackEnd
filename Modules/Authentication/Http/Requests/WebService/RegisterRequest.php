...
class RegisterRequest extends FormRequest
{
    ...
    public function rules()
    {
        $rules = [
            ...
            'mobile' => 'nullable|string|min:8|unique:users,mobile',
            // 'mobile' => ['required',
        ...
        if (!is_null($this->address)) {
            $addressRules = [
                ...
                'address.mobile' => 'nullable|string|min:8',
    ...
    public function messages()
    {
        ...
        $v = [
            ...
            'mobile.min' => __('authentication::api.register.validation.mobile.digits_between'),
            ...
            'address.mobile.min' => __('authentication::api.register.validation.mobile.digits_between'),
